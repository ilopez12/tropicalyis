			...
			<div class="main-sidebar main-sidebar-sticky side-menu">
				...
				<div class="main-sidebar-body">
					<ul class="nav">
						...
						<li class="nav-header"><span class="nav-label">Administración</span></li>
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link" href="{{url('admin/departments')}}"><span class="shape1"></span><span class="shape2"></span><i class="si si-briefcase sidemenu-icon"></i><span class="sidemenu-label">Departamentos</span></a>
						</li>
