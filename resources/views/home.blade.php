...
@section('content')
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Bienvenida {{Auth::user()->name}}</h2>
								<ol class="breadcrumb">
										...
										<div class="card bg-primary custom-card card-box">
											<div class="card-body p-4">
												<div class="row align-items-center">
													...
													<img src="{{URL::asset('assets/img/pngs/work3.png')}}" alt="user-img" class="wd-200">
												</div>
											</div>
										</div>
									</div>
											...
											<div class="card-body">
												<div class="card-item">
													...
													<div class="card-item-title mb-2">
														<label class="main-content-label tx-13 font-weight-bold mb-1">Pedidos del día</label>
														<span class="d-block tx-12 mb-0 text-muted">Pedidos del día {{\Carbon\Carbon::parse(date(now()))->format('d/m/Y')}}</span>
													</div>
													<div class="card-item-body">
														<div class="card-item-stat">
															<h4 class="font-weight-bold">{{count($deldia)}}</h4>
										...
										<div class="card custom-card">
											<div class="card-body">
												<div class="card-item">
													...
													<div class="card-item-title mb-2">
														<label class="main-content-label tx-13 font-weight-bold mb-1">Enviados</label>
														<span class="d-block tx-12 mb-0 text-muted">Pedidos Enviados</span>
													</div>
													<div class="card-item-body">
														<div class="card-item-stat">
															<h4 class="font-weight-bold">{{$enviados}}</h4>
										...
										<div class="card custom-card">
											<div class="card-body">
												<div class="card-item">
													...
													<div class="card-item-title  mb-2">
														<label class="main-content-label tx-13 font-weight-bold mb-1">Pedidos sin enviar</label>
														<span class="d-block tx-12 mb-0 text-muted">Pedidos en espera por envio al restaurante</span>
													</div>
													<div class="card-item-body">
														<div class="card-item-stat">
															<h4 class="font-weight-bold">{{$porenviar}}</h4>
									...
									<table class="table table-hover m-b-0 transcations mt-2">
										<tbody>
											<tr>
												<td class="wd-5p">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle mr-3" src="{{URL::asset('assets/img/users/5.jpg')}}">
													</div>
												</td>
												<td>
											 ...
											 <tr>
												<td class="wd-5p">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle mr-3" src="{{URL::asset('assets/img/users/6.jpg')}}">
													</div>
												</td>
												<td>
													<div class="d-flex align-middle ml-3">
											...
											<tr>
												<td class="wd-5p">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle mr-3" src="{{URL::asset('assets/img/users/7.jpg')}}">
													</div>
												</td>
												<td>
													<div class="d-flex align-middle ml-3">
											...
											<tr>
												<td class="wd-5p">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle mr-3" src="{{URL::asset('assets/img/users/8.jpg')}}">
													</div>
												</td>
												<td>
													<div class="d-flex align-middle ml-3">
											...
											<tr>
												<td class="wd-5p pb-0">
													<div class="main-img-user avatar-md">
														<img alt="avatar" class="rounded-circle mr-3" src="{{URL::asset('assets/img/users/4.jpg')}}">
													</div>
												</td>
												<td class="pb-0">
													<div class="d-flex align-middle ml-3">
								...
								<div class="card custom-card">
									...
									<div class="card-body pt-2 mt-0">
										<div class="list-card">
											...
											<div class="card-item mt-4">
												<div class="card-item-icon bg-transparent card-icon">
													<span class="peity-donut" data-peity='{ "fill": ["#24243e", "rgba(204, 204, 204,0.3)"], "innerRadius": 15, "radius": 20}'>6/7</span>
												</div>
												<div class="card-item-body">
													<div class="card-item-stat">
										...
										<div class="list-card mb-0">
											...
											<div class="card-item mt-4">
												<div class="card-item-icon bg-transparent card-icon">
													<span class="peity-donut" data-peity='{ "fill": ["#24243e", "rgba(204, 204, 204,0.3)"], "innerRadius": 15, "radius": 20}'>5/7</span>
												</div>
												<div class="card-item-body">
													<div class="card-item-stat">
