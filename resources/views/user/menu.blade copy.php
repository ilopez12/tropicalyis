              ...
              @foreach ($restaurante as $key => $val)
                <div class="card">
                  ...
                  <div aria-labelledby="headingOne" class="collapse" data-parent="#accordion" id="collapseOne{{$val->id}}" role="tabpanel">
                    <div class="col-6 mg-t-20" style="text-align: left;">
                      <h6>PRINCIPAL</h6>
                    </div> <div class="card-body">
                      <div class="col-6 mg-t-15">
                        <table>
                          <tbody>
                        ...
                        <div class="col-6" style="text-align:left">
                          ...
                          <table style="text-align:left">
                            ...
                            <tbody>
                              ...
                              {{-- <input type="hidden" name="cantidad" id="cantidad" value="{{$key}}"> --}}
                              @endif
                            @endforeach
                            </tbody>
                          </table>
                            ...
                            @foreach ($menu as $key => $item)
                              @if ($item->restaurante == $val->id)
                                <tr>
                                  <td><input onclick="actualiza_costo({{json_encode($item)}})" type="radio" name="proteina" value="{{$item->id}}" id="proteina[{{$key}}]"></td>
                                  <td  style="width: 60%">{{$item->nombre}}</td>
                                  <td>${{number_format($item->costo_adicional, 2)}}</td>
                                </tr>   
                              @endif
                            @endforeach
                            @foreach ($acomp as $key => $item)
