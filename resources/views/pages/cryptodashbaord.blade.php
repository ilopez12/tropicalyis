									...
									<div class="table-responsive border-0">
										<table class="table border-0 mg-b-0 text-nowrap text-md-nowrap">
											<tbody>
												<tr>
													<td class="d-flex">
													<div class="cryp-icon bg-primary my-auto mr-2"> <i class="cf cf-btc"></i> </div>
									...
									<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
										<div class="card custom-card">
											<div class="card-body">
												...
												<div class="row mt-3">
													<div class="col-sm-6 my-auto border-right text-centerd-flex no-block align-items-center">
														<div class="d-flex">
															<span class="peity-donut" data-peity='{ "fill": ["#24243e","#f16d75","#19b159"], "innerRadius": 20, "radius": 16, "height": 50, "width": 50}'>10,4,4</span>
												...
												<tbody>
													<tr>
														...
														<td class="coin_icon mt-2 d-flex">
															<div class="cryp-icon bg-primary mr-2"> <i class="cf cf-btc"></i> </div>
													...
													<tr>
														<td>2</td>
														<td class="coin_icon mt-2 d-flex">
															<div class="cryp-icon bg-primary my-auto mr-2"> <i class="cf cf-eth"></i> </div>
													...
													<tr>
														<td>3</td>
														<td class="coin_icon mt-2 d-flex">
															<div class="cryp-icon bg-primary my-auto mr-2"> <i class="cf cf-xrp"></i> </div>
													...
													<tr>
														<td>4</td>
														<td class="coin_icon mt-2 d-flex">
															<div class="cryp-icon bg-primary my-auto mr-2"> <i class="cf cf-ltc"></i> </div>
