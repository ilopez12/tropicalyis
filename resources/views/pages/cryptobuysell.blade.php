								...
								<div class="card custom-card overflow-hidden">
									<div class="d-flex mb-3 p-3 border-bottom">
										<div class="align-items-center">
											<h4 class="d-flex">Bitcoin<span class="text-muted tx-13 ml-2 my-auto">BTC</span></h4>
										</div>
										<button class="btn btn-primary ml-auto">Buy Bitcoin</button>
									</div>
									<div class="card-body">
										<div class="d-sm-flex mb-0">
											<div class="">
												<p class="tx-13 text-muted mb-2">Bitcoin [BTC] Price Chart</p>
												<h3>$3468.42<span class="text-success tx-15 ml-2"><i class="fas fas fa-dollar-sign"></i> 23.5</span></h3>
											</div>
											<div class="ml-auto">
									...
									<div class="card-body">
										...
										<div class="d-flex mt-3 mb-3">
											<div class="">
												...
												<h3>5.47<span class="text-success tx-15 ml-2">CNY</span></h3>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<div class="input-group-append wd-30p">
													<select class="form-control border-left-0 icons_select2 br-0" data-placeholder="Seleccione">
									...
									<div class="card-body">
										...
										<div class="form-group">
											...
											<div class="p-3 border d-flex">
												<div class="d-flex"><span class="crypto-icon bg-primary-transparent mr-3"><i class="cf cf-btc text-primary"></i></span><span class="my-auto tx-18 font-weight-semibold">Bitcoin BTC</span></div>
