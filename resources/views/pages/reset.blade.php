										...
										<div class="card-body mt-2 mb-2">
											...
											<p class="mb-4 text-muted tx-13 ml-0 text-left">It's free to signup and only takes a minute.</p> --}}
												...
												<div class="form-group text-left">
													...
													<input class="form-control" placeholder="Ingrese su password" type="password">
												</div>
												<button onclick="resetP()" class="btn ripple btn-main-primary btn-block">Reset Password</button>
