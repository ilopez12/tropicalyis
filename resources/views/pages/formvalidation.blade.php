									...
									<div class="card-body">
										...
										<form action="{{url('form-validation')}}" class="parsley-style-1" id="selectForm2" name="selectForm2">
											...
											<div class="parsley-select  mg-t-30" id="slWrapper2">
												<select class="form-control select2" data-parsley-class-handler="#slWrapper2" data-parsley-errors-container="#slErrorContainer2" data-placeholder="Seleccione" required="">
										...
										<form action="{{url('form-validation')}}" id="selectForm" name="selectForm">
											<div class="d-sm-flex">
												<div class="parsley-select wd-sm-250" id="slWrapper">
													<select class="form-control select2" data-parsley-class-handler="#slWrapper" data-parsley-errors-container="#slErrorContainer" data-placeholder="Seleccione" required="">
														<option label="Seleccione">
														</option>
														<option value="Firefox">
															Firefox
